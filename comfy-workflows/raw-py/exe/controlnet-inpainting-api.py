...
prompt_concat = "pink glasses"
#prrompt_template = "dewiratih, {blonde|} {__color__|} {sexy|} {__dress__|__cute__|__elegant__}, {pink|} glasses"
neg="text, wAtermark"
img_folder="/content/img/masking/content/Masking/B3u650/img"
mask_folder="/content/img/masking/content/Masking/B3u650/mask"
...
cfg=1
steps=8
folder_name="dwrt-cn-inpaint-[time(%Y-%m-%d-%H)]"
        ...
        for q in range(num_iterations):
            ...
            for prompt in prompts:
                ...
                inpaintpreprocessor_37 = inpaintpreprocessor.preprocess(
                    image=get_value_at_index(imagescale_59, 0),
