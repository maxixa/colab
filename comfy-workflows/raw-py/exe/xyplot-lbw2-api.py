...
lists = [
    ['meganekko11.pt', 'RAW photo, woman wearing glasses, dslr, soft lighting, high quality, film grain, Fujifilm XT3'],
    ['meganekko-3.ckpt', 'RAW photo, woman wearing glasses, dslr, soft lighting, high quality, film grain, Fujifilm XT4'],
    ['dwrtng-512.safetensors', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT6'],
    ['dwrtng-512-000005.safetensors', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT7'],
    ['dwrtng-768.safetensors', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT8'],
    ['dwrtbg-512.safetensors', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT9'],
    ['dwrtmg-512.safetensors', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT10'],
    ['dwrtmg-768.safetensors', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT11'],
    ['dwrtng-60-1500-768-db.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT11'],
    ['dwrtng-60-1500-512-db.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT12'],
    ['dwrtsg-65-768-DB1.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT13'],
    ['dwrtsg-65-768-DB2.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT14'],
    ['dwrtsg-65-768-DB3.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT15'],
    ['dwrtsg-65-768-DB4.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT16'],
    ['dwrtsg-65-512-DB1.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT17'],
    ['dwrtsg-65-512-DB2.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT18'],
    ['dwrtsg-65-512-DB3.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT19'],
    ['dwrtsg-65-512-DB4.ckpt', 'RAW photo, dewiratih dslr, soft lighting, high quality, film grain, Fujifilm XT20'],
...
def main():
    ...
    with torch.inference_mode():
        for lora_model,triger_prompt in lists:
            ...
            xy_plot_11 = xy_plot.XYplot(
                my_unique_id=random.randint(1, 2**64),
                grid_spacing=0,
                XY_flip="False",
