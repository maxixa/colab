...
prrompt_template = "RAW photo, dewiratih, {blonde| } {__hairacc__| } {__hair__| }, wearing ({__color__|} {sexy| } {__dress__|__cute__|__elegant__|__sexyoutfit__|__mini1__}:1.3), {pink| } glasses, fashion photoshot, detailed,  dynamic pose, studio lghting, {white|__simbg__|__placebg__} background, (pale skin:1.3), soft lighting, film grain, Fujifilm XT3"  #@param {'type' : 'string'}
