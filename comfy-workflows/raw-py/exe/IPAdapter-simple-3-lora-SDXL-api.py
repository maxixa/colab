...
prrompt_template = "sexy, girl, {blonde|}, {lolita|ballgown|princess|maid}, {pink|red|blue|} glasses"
...
cfg=1
steps=8
output_path="/content/drive/MyDrive/outputs/dwrt-ip-xl-[time(%Y-%m-%d-%H)]"
