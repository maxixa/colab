...
cfg=1
steps=8
output_path="/content/drive/MyDrive/outputs/dwrt-ip-[time(%Y-%m-%d-%H)]"
...
def main():
    ...
    with torch.inference_mode():
        ...
        controlnetloader_32 = controlnetloader.load_controlnet(control_net_name=control_net_name)
        ...
        for q in range(num_iterations):
            ...
            for prompt in prompts:
                ...
                load_image_batch_30 = load_image_batch.load_batch_images(
                ...
                prepimageforclipvision_31 = prepimageforclipvision.prep_image(
                    interpolation="LANCZOS",
                    crop_position="top",
                    sharpening=0,
                    image=get_value_at_index(load_image_batch_30, 0),
                )
                ...
                ipadapterapply_18 = ipadapterapply.apply_ipadapter(
                    ...
                    image=get_value_at_index(prepimageforclipvision_31, 0),
                    model=get_value_at_index(loraloaderblockweight_inspire_27, 0),
                )

                load_image_batch_35 = load_image_batch.load_batch_images(
                    mode="incremental_image",
                    index=0,
                    label="Batch 002",
                ...
                controlnetapply_33 = controlnetapply.apply_controlnet(
                    strength=1,
                    conditioning=get_value_at_index(cliptextencode_25, 0),
                    control_net=get_value_at_index(controlnetloader_32, 0),
                    image=get_value_at_index(load_image_batch_35, 0),
                )
                ...
                ksampler_3 = ksampler.sample(
                    ...
                    positive=get_value_at_index(controlnetapply_33, 0),
