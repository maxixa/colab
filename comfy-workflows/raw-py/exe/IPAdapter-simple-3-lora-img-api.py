        ...
        for q in range(num_iterations):
            for img in os.listdir(img_folder):
                ...
                for prompt in prompts:
                    for img2img in os.listdir(img2img_folder):
                        img2img_path = os.path.join(img2img_folder, img2img)
                        ...
                        repeatlatentbatch_40 = repeatlatentbatch.repeat(
                            amount=2, samples=get_value_at_index(vaeencode_28, 0)
                        )
