...
prrompt_template = "A  surrealistic {__o/fruits__|__o/bubble__|__o/vegetables__|__o/vegetables__|__o/candy__} , 2{liquid splash||} __m/colortheme__ theme"
#prrompt_template = "dewiratih, {blonde|} {__color__|} {sexy|} {__dress__|__cute__|__elegant__}, {pink|} glasses"
neg="text, wAtermark"
img_folder="/content/img/ref/vector-wall/80_Colorful_Wallpapers_1920_X_1200"
img2img_folder="/content/img/ref/vector-wall/Best_Se7en_Wallpapers"
ckpt_name="RunDiffusionFX25D.safetensors"
...
denoise=random.randint(55,80)/100 #img2img denoise 
folder_out_name="abs-ip-[time(%Y-%m-%d-%H)]"
