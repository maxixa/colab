...
def main():
    ...
    with torch.inference_mode():
        ...
        clipseg_46 = clipseg.segment_image(
            text="woman",
            blur=0.1,
        ...
        combinesegmasks = NODE_CLASS_MAPPINGS["CombineSegMasks"]()
        combinesegmasks_50 = combinesegmasks.combine_masks(
            mask_1=get_value_at_index(clipseg_46, 0),
            mask_2=get_value_at_index(clipseg_47, 0),
        )
        ...
        vaeencodeforinpaint_21 = vaeencodeforinpaint.encode(
            ...
            mask=get_value_at_index(combinesegmasks_50, 0),
        )
