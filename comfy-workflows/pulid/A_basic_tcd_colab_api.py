...
def main():
    ...
    with torch.inference_mode():
        ...
        emptylatentimage_5 = emptylatentimage.generate(
            width=1024, height=578, batch_size=1
        )
