...
prrompt_template = "{candid photography|elegance|fashion|fashion photography|stylish|casual style|cinematic} photo of woman,  (round glasses:1.2), {Over-the-Shoulder Look| Leaning Against a Wall| Sitting on the Ground| Walking Toward the Camera| Arms Crossed| Hands on Hips| Lean Forward| One Hand on Chin| Twirling Hair|  Hand in Hair| Crossed Legs, Standing| Hands Behinprojectiontiontion| Laying on Stomach| Sitting | projectionng Face Lightly|  Holding a Prop| Leaning Forward with Elbows on Knees| Hands Clasped Together|  One Foot Forward| Hugging Self| Resting Head on Hand| Hands Resting on Lap| Mid-Spin with Dress|sitting pose|laying pose|kneeling pose|sitting pose|laying pose|kneeling pose}, {||twintails}, {blonde|}, {bow hair|cat ears|Bows|Hair Clips|Headbands|Hair Ties|Ponytail Holders |Crown Headbands |Braided Headbands }, {(sexy:1.3)|}{|pink|red|peach|maroon|light-blue|pink|light green|Cream|white|Tan|Blush|Rose| white|pink| white|} {lolita dress|fairy dress, wings|princess dress|ballgown|wedding dress| BUTTERFLY DRESS, wings|BURLESQUE DRESS|CUTE mini DRESS|FLOWER DRESS| VICTORIAN DRESS| VICTORIAN mini DRESS} ,{||white thighhighs||white stockings|}, {Sashes|Ruffles|Bows|Ribbons|Lace Trims|Petticoats|Tutus|Belts|Buckles|Brooches|Flower Pins|Appliques|Embroidery|Patches|Ribbon Bows|Dress Clips|Waist Belts|Dress Pins|Dress Brooches|Dress Sashes}, {flared skirt|flared mini skirt||}, {depth of field|kitchen|white|blurred|indoor|white|bokeh} background, {elegance|model photoshot}, {fashion|fashion photography},  dynamic pose, {high-resolution image-|high-resolution}"
