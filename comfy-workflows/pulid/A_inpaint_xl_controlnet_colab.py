...
prrompt_template = "cinematic, glamour photo of woman, glasses, {||twintails}, sexy,  dynamic pose, {blonde|},high-heels. {bow hair|cat ears|Bows|Hair Clips|Headbands|Hair Ties|Barrettes|Hair Slides|Ponytail Holders|Hair Pins|Bobby Pins|Hair Sticks|Hair Combs|Scrunchies|Hair Tassels|Crown Headbands|Hair Charms|Braided Headbands|Hair Wraps|Ponytail Streamers|Glitter Hair Ties}, {pink|red|peach|pink|light-blue|white|Cream} {lolita mini dress|fairy dress, wings||BURLESQUE DRESS|CUTE mini DRESS} ,{white thighhighs|white stockings}, {Sashes|Ruffles|Bows|Ribbons|Lace Trims|Petticoats|Tutus|Belts|Buckles|Brooches|Flower Pins|Appliques|Embroidery|Patches|Ribbon Bows|Dress Clips|Waist Belts|Dress Pins|Dress Brooches|Dress Sashes}, {mini flared skirt|}, {depth of field|kitchen|garden|blurred|indoor|white|bokeh} background, {elegance|model photoshot}, {fashion|fashion photography},  {high-resolution image-|high-resolution}"
              ...
              for image_file in image_files:
                ...
                if f'{name}.{mask_ext}' in mask_files:
                  ...
                  image_save_29 = image_save.was_save_images(
                      output_path=f"{output_path}/{ckpt_name}",
