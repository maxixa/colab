...
num_que = 1 #number of general repeat
...
ckpts = (
    "LEOSAM-s-HelloWorld-XL.safetensors",
    "NightVisionXL-9.safetensors",
    "Realism_Engine_SDXL_3.safetensors",
    "STOIQO_NewReality.safetensors",
    "XXMix_9realisticSDXL.safetensors",
    "iNiverse_Mix_XL.safetensors",
...
# !aria2c -o LEOSAM-s-HelloWorld-XL.safetensors --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Maxixa/civit-xl/resolve/main/LEOSAM-s-HelloWorld-XL.safetensors
# !aria2c -o NightVisionXL-9.safetensors --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Maxixa/civit-xl/resolve/main/NightVisionXL-9.safetensors
# !aria2c -o Realism_Engine_SDXL_3.safetensors --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Maxixa/civit-xl/resolve/main/Realism_Engine_SDXL_3.safetensors
# !aria2c -o STOIQO_NewReality.safetensors --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Maxixa/civit-xl/resolve/main/STOIQO_NewReality.safetensors
# !aria2c -o XXMix_9realisticSDXL.safetensors --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Maxixa/civit-xl/resolve/main/XXMix_9realisticSDXL.safetensors
# !aria2c -o iNiverse_Mix_XL.safetensors --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/Maxixa/civit-xl/resolve/main/iNiverse_Mix_XL.safetensors
...
img_mask_folder = (
  ...
  # ('/content/Masking/content/94-mask/550/img','/content/Masking/content/94-mask/550/mask','png'),
  # ('/content/Masking/content/94-mask/600/img','/content/Masking/content/94-mask/600/mask','png'),
...
#   ('/content/Masking/content/89/500/img','/content/Masking/content/89/500/mask','png'),
#   ('/content/Masking/content/89/250/img-fliped','/content/Masking/content/89/250/mask-fliped','png'),
#   ('/content/Masking/content/89/300/img-fliped','/content/Masking/content/89/300/mask-fliped','png'),
#   ('/content/Masking/content/89/350/img-fliped','/content/Masking/content/89/350/mask-fliped','png'),
#   ('/content/Masking/content/89/400/img-fliped','/content/Masking/content/89/400/mask-fliped','png'),
#   ('/content/Masking/content/89/450/img-fliped','/content/Masking/content/89/450/mask-fliped','png'),
#   ('/content/Masking/content/89/500/img-fliped','/content/Masking/content/89/500/mask-fliped','png'),
                  ...
                  for image_file in image_files:
                    ...
                    if f'{name}.{mask_ext}' in mask_files:
                      ...
                      image_save_29 = image_save.was_save_images(
                          output_path=f"{output_path}/{ckpt}",
